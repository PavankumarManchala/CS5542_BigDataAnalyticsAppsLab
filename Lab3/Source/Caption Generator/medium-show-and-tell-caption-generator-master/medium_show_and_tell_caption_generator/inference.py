...
tf.flags.DEFINE_string("model_path", "C:\BigDataAnalyticsAppns\Tutorial 6 Source Code\medium-show-and-tell-caption-generator-master\model\show-and-tell.pb", "Model graph def path")
tf.flags.DEFINE_string("vocab_file", "C:\BigDataAnalyticsAppns\Tutorial 6 Source Code\medium-show-and-tell-caption-generator-master\etc\word_counts.txt", "Text file containing the vocabulary.")
#tf.flags.DEFINE_string("input_files", "C:\BigDataAnalyticsAppns\Tutorial 6 Source Code\medium-show-and-tell-caption-generator-master\imgs\\trading_floor.jpg",
tf.flags.DEFINE_string("input_files", r"C:\Users\Pavankumar Manchala\Desktop\Cupcakes\b.jpg",
